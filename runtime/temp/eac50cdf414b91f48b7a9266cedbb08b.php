...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-classify_id" data-rule="required" data-source="classify/index" class="form-control selectpage" name="row[classify_id]" type="text" value="<?php echo htmlentities($row['classify_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Commodityname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-commodityname" data-rule="required" class="form-control" name="row[commodityname]" type="text" value="<?php echo htmlentities($row['commodityname']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Cspecification'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-cspecification" data-rule="required" class="form-control" name="row[cspecification]" type="text" value="<?php echo htmlentities($row['cspecification']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-repertory" data-rule="required" class="form-control" name="row[repertory]" type="number" value="<?php echo htmlentities($row['repertory']); ?>">
        </div>
    </div>
