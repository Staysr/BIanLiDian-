                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <ul class="products-list product-list-in-box">
                                    <?php $__FOR_START_1531149103__=1;$__FOR_END_1531149103__=8;for($i=$__FOR_START_1531149103__;$i < $__FOR_END_1531149103__;$i+=1){ ?>
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/BIanLiDian/public/assets/img/avatar.png" style="height:40px;width:40px;">
                                        </div>
