define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'commoditys/index' + location.search,
                    add_url: 'commoditys/add',
                    edit_url: 'commoditys/edit',
                    del_url: 'commoditys/del',
                    multi_url: 'commoditys/multi',
                    table: 'commoditys',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'commoditys/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
